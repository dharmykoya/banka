...
describe('Transaction Resource', () => {
  ...
  this action if client try to debit an account`, (done) => {
    chai
      .request(app)
      .post('/api/v1/transactions/2000000000/debit')
      .send({
  ...
  transaction for incorrect account number`, (done) => {
    chai
      .request(app)
  ...
  debit transaction for incorrect account number`, (done) => {
    chai
      .request(app)
  ...
  while doing credit transaction`, (done) => {
    chai
      .request(app)
  ...
  it(`should return Account is dormant. Please reactivate. 
  while debitting an account`, (done) => {
    chai
      .request(app)
      .post('/api/v1/transactions/2000000000/debit')
      .send({
